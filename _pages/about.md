...
* **Technologies and Packages:** Genesis, NVIDIA IsaacGym, PyTorch, AWS (Cloud Computing), High Performance/Cluster Computing, Docker, COMSOL Multiphysics, ANSYS Electronics, ANSYS Lumerical, SolidWorks, CERN Root, Geant4, Git, NumPy, Matplotlib
